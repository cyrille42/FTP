...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/04/29 00:15:04 by cgay              #+#    #+#             */
/*   Updated: 2015/04/29 00:15:04 by cgay             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_get(int sock, char *buf, t_list *paquet)
{
	int		fd;
...
void	ft_put(int sock, char *buf, t_list *paquet)
{
	int		len;
	char	*str;
	...
	else
	{
		...
		if (ft_strcmp(buf, "ERROR;") == 0)
			...
			envoie_fichier_to_client(str, sock);
	}
	paquet->put = 0;
}
